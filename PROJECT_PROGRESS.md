...
No task is currently marked `READY` or `IN_PROGRESS` in `ROADMAP_TODO.md`. The next implementation must follow the dependency queue and claim only the first dependency-safe task.

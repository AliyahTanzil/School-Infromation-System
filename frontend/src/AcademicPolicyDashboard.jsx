    ...
    <main className="page-shell">
        ...
        <section className="panel" aria-label="Grading setup guidance">
          ...
          {activePolicy ? (
            ...
            <p>
              ...
              . Check that grade bands cover 0â€“100 and assessment weights total 100%.
            </p>
          ) : (
            <p>
      ...
      <section id="policy-draft" className="panel">
        ...
        <form onSubmit={create} className="space-y-3">
          ...
          <p>
            Grade bands must cover 0â€“100 without gaps; assessment weights must total 100% before
            activation.
          </p>
      ...
      <section id="policy-register" className="panel">
        ...
        {loading && <p role="status">Loading grading policiesâ€¦</p>}

...
import classRouter, { classAdmin } from '../../src/presentation/http/routes/classRoutes.js';
import subjectRouter, { subjectAdmin } from '../../src/presentation/http/routes/subjectRoutes.js';

for (const [name, router, guard] of [
  ['class', classRouter, classAdmin],
  ['subject', subjectRouter, subjectAdmin],
]) {

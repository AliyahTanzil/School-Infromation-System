...
export default {
  portal: async (req, res) => send(res, await parentService.getPortal(req.parent.id, req)),
  updateProfile: async (req, res) =>
    send(res, await parentService.updateProfile(req.parent.id, req.body)),
  link: async (req, res) =>
    send(
      res,
      await parentService.link(req.parent.id, req.body.studentId, req.body.relationship),
      201
    ),

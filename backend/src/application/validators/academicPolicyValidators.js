import { z } from 'zod';
const policyId = z.object({ id: z.string().uuid() }).strict();
export const academicPolicyIdSchema = z.object({ params: policyId });
...
export const academicPolicyQuerySchema = z.object({
  query: z.object({ status: z.enum(['DRAFT', 'ACTIVE', 'ARCHIVED']).optional() }).strict(),
});
